...
@Component({
  selector: "app-add-contentvet",
  templateUrl: "./add-contentvet.component.html",
  styleUrls: ["./add-contentvet.component.scss"],
})
export class AddContentvetComponent implements OnInit {
  ...
  ajouterContent() {
    ...
    this.contenuInformatifService.add(formData).subscribe(
      (response: any) => {
        ...
        this.router.navigate(["/dashboardVet/gestionContent"]);
      },
