...
@Component({
  selector: "app-content-vet",
  templateUrl: "./content-vet.component.html",
  styleUrls: ["./content-vet.component.scss"],
})
export class ContentVetComponent implements OnInit {
  cards: Card[] = [];
  responseMessage: any;
  id_user: number = 1;
  filteredCards: Card[] = [];
  ...
  showDetails(id: string) {
    this.router.navigate(["/dashboardVet/detailsContent", id]);
