...
@Component({
  selector: 'app-modifie-profil',
  templateUrl: './modifie-profil.component.html',
  styleUrls: ['./modifie-profil.component.scss']
})
export class ModifieProfilComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.profileForm.valid) {
      ...
      formData.append('cin', this.profileForm.value.cin);
